...
#%%
lumi_mot_regressors = pd.read_csv(r"C:\Users\ag-bahl\Desktop\Max\master_thesis\Katjas_model_regressors.tsv", sep="\t",
...
pickle_save_object((mi_warp_barycenters, stim_index), rf'.data\{today}_motion_integrator_warp_responses.pkl')
...
#%% load janelia data
warp_data_dir = pathlib.Path(r"...\postprocessed")
...
pickle_save_object((janelia_traces,mask), rf".\data\{today}_janelia_trace_df.pkl")

#%%
janelia_traces,mask = pickle_load_object(r".\data\2026-07-24_janelia_trace_df.pkl")
warp_MI_regressors, stimuli = pickle_load_object(r".\data\2026-07-15_motion_integrator_warp_responses.pkl")
warp_data_dir = pathlib.Path(r"...\postprocessed")
...
# warp cells are registered to mapzebrain but plot them on the zbrain
...
# do binary expression first to get a nice grouping of cells
cg = sns.clustermap(
